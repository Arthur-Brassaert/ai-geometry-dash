...
[Arthur Brassaert]
## Algemene conclusie 
Het hoofddoel van het project is behaald, namelijk het creëren van een AI die autonoom Geometry Dash kan spelen.

Hierdoor zien we dit als een geslaagd project waarbij we ook de subdoelen behaald hebben. 
...
Deze analyse was de basis van ons project, hierna zijn we begonnen aan het trainen van ons AI-model. 

Het getrainde model is nu in staat om zelfstandig het spel te spelen zonder enige menselijke input.
